...
<head>
	...
	<meta name="decription" content="<?php if ( is_singular() ){if (!empty(the_expert())):echo get_the_excerpt();else:echo get_the_title();endif;}else{echo 'ロボット・ヒューマノイドの情報メディア、ロボ部です！';}?>"> 
	<script>
