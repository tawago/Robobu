<html>
	<head>
		...
		<style>
			...
			#fullpage{
				background-image:url(<?php get_stylesheet_directory_uri(); ?>/img/robobu-top.png) ; 
	...
	<body>
		<div id="fullpage">
			<div class="section">
				<img src="../wp-content/themes/Robobu/img/robobuin.png" style="float:right; margin:50px 140px 0 0;" width="200">
				<h1>{Robobu:ロボ部}</h1>
		...
		<div id="wrap">
			<section id="top_about">
				...
				<div class="about_type">
					<h3>試してみた</h3>
					<img src="../wp-content/themes/Robobu/img/robo-b.png" width="200">
					<p>ロボットは可能性が無限大。日々思いつくアイデアから何ができるか実験</p>
				</div>
				<div class="about_type">
					<h3>最新情報まとめ</h3>
					<img src="../wp-content/themes/Robobu/img/obo-b.png" width="200">
